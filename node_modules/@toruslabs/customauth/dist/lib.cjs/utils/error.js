...
const CustomAuthLoginErrorPrefix = "CustomAuthLoginError: login failure.";
class CustomAuthLoginError extends Error {
  constructor(message) {
    super(message);
...
exports.CustomAuthLoginError = CustomAuthLoginError;
exports.CustomAuthLoginErrorPrefix = CustomAuthLoginErrorPrefix;
