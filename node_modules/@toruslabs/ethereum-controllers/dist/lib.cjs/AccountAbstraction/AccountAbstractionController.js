...
class AccountAbstractionController extends baseControllers.BaseController {
  ...
  async wrapSignatureWith6492(signature, address) {
    var _this$smartAccount, _this$smartAccount2;
    if (!this.smartAccount) {
      return signature;
    }
    if (address && this.smartAccount.address.toLowerCase() !== address.toLowerCase()) {
      return signature;
    }
    const [isDeployed, factoryArgs] = await Promise.all([(_this$smartAccount = this.smartAccount) === null || _this$smartAccount === void 0 ? void 0 : _this$smartAccount.isDeployed(), (_this$smartAccount2 = this.smartAccount) === null || _this$smartAccount2 === void 0 ? void 0 : _this$smartAccount2.getFactoryArgs()]);
    if (isDeployed) {
      return signature;
    }
    if (!(factoryArgs !== null && factoryArgs !== void 0 && factoryArgs.factory) || !factoryArgs.factoryData) {
      throw new Error("Missing ERC-6492 factory args for undeployed account abstraction wallet");
    }
    return utils.serializeErc6492Signature({
  ...
  async signPersonalMessage(message, address) {
    var _this$smartAccount3;
    if (address.toLowerCase() !== this.smartAccount.address.toLowerCase()) {
      throw new Error("Invalid address");
    }
    return (_this$smartAccount3 = this.smartAccount) === null || _this$smartAccount3 === void 0 ? void 0 : _this$smartAccount3.signMessage({
  ...
  async signTypedData(data, address) {
    var _this$smartAccount4;
    if (address.toLowerCase() !== this.smartAccount.address.toLowerCase()) {
      throw new Error("Invalid address");
    }
    return (_this$smartAccount4 = this.smartAccount) === null || _this$smartAccount4 === void 0 ? void 0 : _this$smartAccount4.signTypedData({
