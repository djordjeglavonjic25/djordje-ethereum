...
class NetworkController extends baseControllers.BaseController {
  ...
  setProvider({
    ...
    const previousBlockTracker = this.blockTracker;
    ...
    if (previousBlockTracker && previousBlockTracker !== blockTracker) {
      previousBlockTracker.destroy();
    }
  }
  configureStandardProvider(providerConfig) {
    const networkClient = createJsonRpcClient.createJsonRpcClient(providerConfig, this.config, this.getNetworkIdentifier.bind(this), this.idleTimeTracker, this.analytics);
