...
import { GetEthCodeFn, TransactionParams } from "../utils/interfaces";
/**
...
export declare function isAtomicBatchTransaction(txParams: Pick<TransactionParams, "data" | "from" | "to">[]): boolean;
/**
 ...
 */
export declare function decodeEIP7821BatchTransaction(batchTransaction: BatchTransactionParams): {
    mode: Hex;
