...
import { EthereumTransactionMeta, PreparedTransaction, PrepareTransactionOptions, TransactionParams } from "../utils/interfaces";
...
export declare class TransactionController extends TransactionStateManager implements ITransactionController<TransactionParams> {
     ...
     */
    prepareTransaction(txParams: TransactionParams, opts?: PrepareTransactionOptions): Promise<PreparedTransaction>;
    ...
    protected getDefaultGasLimit(txMeta: EthereumTransactionMeta): Promise<{
        gasLimit?: undefined;
    ...
    private applyFeeDefaults;
    private getGasFeesForSpeed;
