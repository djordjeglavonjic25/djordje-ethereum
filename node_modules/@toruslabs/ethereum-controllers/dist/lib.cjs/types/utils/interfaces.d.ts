...
export interface PrepareTransactionOptions {
    /**
     * Gas fee tier for EIP-1559 chains. Default: medium.
     * Ignored on legacy chains.
     */
    speed?: GasSpeed;
    /**
     * Whether to acquire a nonce via NonceTracker. Default: true.
     * Set false when the caller assigns nonces.
     */
    fillNonce?: boolean;
}
