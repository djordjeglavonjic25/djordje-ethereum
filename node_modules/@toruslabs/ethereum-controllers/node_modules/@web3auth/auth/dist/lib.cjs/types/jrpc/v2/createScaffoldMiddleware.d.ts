 ...
 */
export declare function createScaffoldMiddleware<Context extends ContextConstraint>(handlers: MiddlewareScaffold): JRPCMiddlewareV2<JRPCRequest, Json, Context>;
