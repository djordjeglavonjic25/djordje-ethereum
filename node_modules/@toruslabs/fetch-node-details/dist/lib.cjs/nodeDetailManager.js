...
class NodeDetailManager {
  constructor({
    ...
    _defineProperty(this, "fndServerEndpoint", void 0);
    ...
    if (fndServerEndpoint) {
      ...
      this.fndServerEndpoint = `${constants.FND_SERVER_MAP[buildEnv]}/node-details`;
    }
    if (enableLogging) {
      log.enableAll();
    } else {
  ...
  async getMetadataUrl() {
    if (Object.values(constants.TORUS_LEGACY_NETWORK).includes(this.network)) {
      return constants.LEGACY_METADATA_MAP[this.buildEnv];
    }
