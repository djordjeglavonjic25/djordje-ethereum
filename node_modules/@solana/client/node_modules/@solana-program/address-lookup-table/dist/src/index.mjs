import { getProgramDerivedAddress, getAddressEncoder, getU64Encoder, getU32Encoder, transformEncoder, getStructEncoder, getU8Encoder, getOptionEncoder, getU16Encoder, getArrayEncoder, getStructDecoder, getU32Decoder, getU64Decoder, getU8Decoder, getOptionDecoder, getU16Decoder, getArrayDecoder, getAddressDecoder, combineCodec, decodeAccount, assertAccountExists, fetchEncodedAccount, assertAccountsExist, fetchEncodedAccounts, containsBytes, BASE_ACCOUNT_SIZE, AccountRole, upgradeRoleToSigner, isProgramDerivedAddress, isTransactionSigner as isTransactionSigner$1 } from '@solana/kit';
