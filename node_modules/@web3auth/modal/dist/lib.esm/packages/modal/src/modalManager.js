...
import { BUILD_ENV, serializeError } from '@web3auth/auth';
import { Web3AuthNoModal, LOGIN_MODE, cloneDeep, WALLET_CONNECTORS, log, CONNECTOR_INITIAL_AUTHENTICATION_MODE, CONNECTOR_STATUS, CONNECTED_STATUSES, ANALYTICS_EVENTS, sdkVersion, ANALYTICS_SDK_TYPE, withAbort, CONNECTOR_EVENTS, getErrorAnalyticsProperties, WalletInitializationError, fetchProjectConfig, fetchWalletRegistry, WALLET_REGISTRY_URL, CONNECTOR_CATEGORY, CONNECTOR_NAMES, CONNECTOR_NAMESPACES, Web3AuthError, WalletLoginError } from '@web3auth/no-modal';
...
class Web3Auth extends Web3AuthNoModal {
    ...
    _defineProperty(this, "onExternalWalletLogin", async params => {
      ...
      if (this.accountLinkingPickerResolver) {
        ...
        resolver({
          ...
          chainNamespace: (_params$loginParams = params.loginParams) === null || _params$loginParams === void 0 ? void 0 : _params$loginParams.chainNamespace
        });
        return;
      }
      try {
        var _params$loginParams2;
        const connector = this.getConnector(params.connector, (_params$loginParams2 = params.loginParams) === null || _params$loginParams2 === void 0 ? void 0 : _params$loginParams2.chainNamespace);
        // auto-connect WalletConnect in background to generate QR code URI without interfering with user's selected connection
        const shouldStartConnectionInBackground = (connector === null || connector === void 0 ? void 0 : connector.name) === WALLET_CONNECTORS.WALLET_CONNECT_V2;
  ...
  async linkAccount(params) {
    ...
    const resolvedChainConfig = this.resolveLinkAccountChainConfig(params === null || params === void 0 ? void 0 : params.chainId);
    ...
    if (!(params !== null && params !== void 0 && params.connectorName)) {
      ...
      if (pickedSelection.chainNamespace) {
        if (resolvedChainConfig.chainNamespace !== pickedSelection.chainNamespace) {
          ...
          resolvedChainId = ((_this$coreOptions$cha2 = this.coreOptions.chains) === null || _this$coreOptions$cha2 === void 0 || (_this$coreOptions$cha2 = _this$coreOptions$cha2.find(chain => chain.chainNamespace === pickedSelection.chainNamespace)) === null || _this$coreOptions$cha2 === void 0 ? void 0 : _this$coreOptions$cha2.chainId) || resolvedChainId;
