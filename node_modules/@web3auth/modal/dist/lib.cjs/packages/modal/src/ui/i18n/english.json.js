...
var modal = {
  "account-linking.failed-connect-wallet": "Failed to connect with {{wallet}}.",
  "account-linking.failed-switch-wallet": "Failed to switch wallet with {{wallet}}.",
  "account-linking.initializing-wallet": "Initializing {{wallet}}...",
  "account-linking.linking-wallet": "Linking wallet...",
  "account-linking.preparing-wallet-qr": "Preparing {{wallet}} QR code...",
  "account-linking.scan-wallet": "Scan the QR code with {{wallet}}.",
  "account-linking.scan-walletconnect": "Scan the QR code with a WalletConnect-compatible wallet.",
  "account-linking.switching-wallet": "Switching wallet...",
  "account-linking.wallet-connected-preparing-linking": "Wallet connected. Preparing account linking...",
  "account-linking.wallet-connected-preparing-switch": "Wallet connected. Preparing account switch...",
  "account-linking.wallet-linked": "Wallet linked.",
  "account-linking.wallet-switched": "Wallet switched.",
  ...
  "blocked.change-wallet": "Change wallet",
  "blocked.primary-message": "You cannot access the site.",
  "blocked.secondary-message": "Access to the site is restricted",
...
var passwordless = {
  "captcha-default-error": "An unexpected error occurred during verification. Please try reloading the page.",
