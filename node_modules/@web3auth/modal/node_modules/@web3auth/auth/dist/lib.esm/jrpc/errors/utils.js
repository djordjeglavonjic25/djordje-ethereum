...
import { isObject, hasProperty } from '../../utils/utils.js';
...
function buildError(error, fallbackError, shouldPreserveMessage) {
  ...
  const fallbackWithCause = _objectSpread(_objectSpread(_objectSpread({}, fallbackError), shouldPreserveMessage && originalMessage && {
...
export { JSON_RPC_SERVER_ERROR_MESSAGE, dataHasCause, getMessageFromCode, isPlainObject, isValidCode, isValidNumber, isValidString, serializeCause, serializeJrpcError };
