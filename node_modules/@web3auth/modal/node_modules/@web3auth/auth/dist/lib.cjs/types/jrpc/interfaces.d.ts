 ...
 */
export type JRPCMiddleware<T extends JRPCParams = JRPCParams, U = unknown> = (req: JRPCRequest<T>, res: JRPCResponse<U>, next: JRPCEngineNextCallback, end: JRPCEngineEndCallback) => void;
/**
 ...
 * @deprecated Use {@link JRPCMiddlewareV2} instead — V2 middleware is async by default.
 */
export type AsyncJRPCMiddleware<T extends JRPCParams, U> = (req: JRPCRequest<T>, res: PendingJRPCResponse<U>, next: AsyncJRPCEngineNextCallback) => Promise<void>;
/**
 * @deprecated Part of the JRPC V1 middleware signature. Use {@link JRPCMiddlewareV2} instead.
 */
