...
class PopupHandler extends BaseController {
  constructor({
    ...
    this.defaultConfig = {
      ...
      communicationEngineNotificationManager: null,
      timeout: 30000,
      instanceId: "",
  ...
  async open() {
    ...
    const {
      ...
      communicationEngineNotificationManager
    } = this.config;
    const {
      windowId,
      url
