 ...
 */
const numberToHexPrefixedString = (value, options) => {
  ...
  return (options === null || options === void 0 ? void 0 : options.prefixed) === false ? hex$1 : hex.add0x(hex$1);
};
/**
 ...
 */
const bigIntToHexPrefixedString = (value, options) => {
 ...
 */
const bigintToHex = (value, length = 64, options) => {
  let hex$1 = value.toString(16).padStart(length, "0");
  if (hex$1.length % 2 !== 0) {
    hex$1 = "0" + hex$1;
  }
  return options !== null && options !== void 0 && options.prefixed ? hex.add0x(hex$1) : hex$1;
};
/** @deprecated Use bigintToHex. Kept for backward compatibility. */
const bigIntToHexPaddedString = bigintToHex;
/**
