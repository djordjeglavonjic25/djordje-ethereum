import { JRPCEngineV2, JRPCRequest, ProviderEvents, RequestArguments, SafeEventEmitter, SafeEventEmitterProvider, SendCallBack } from "@web3auth/auth";
...
declare abstract class BaseProvider<U extends BaseProviderState, E extends ProviderEvents = ProviderEvents> extends SafeEventEmitter<E> implements SafeEventEmitterProvider<E> {
    rpcEngine: JRPCEngineV2;
    jsonRpcConnectionEvents: SafeEventEmitter<import("typed-emitter").EventMap>;
    /**
     ...
     */
    protected abstract rpcRequest<Type = unknown>(payload: UnValidatedJsonRpcRequest, isInternal?: boolean): Promise<Type>;
    /**
