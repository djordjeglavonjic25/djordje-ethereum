import { type JRPCEngineV2, SafeEventEmitter } from "@web3auth/auth";
...
export interface StreamWindowConfig extends BaseConfig {
     ...
     */
    communicationEngine: JRPCEngineV2;
    /**
     * A notification manager which communicates with the popup window.
     * Can send notifications to the other end to create a window (create_window).
     * This is the replacement for communicationEngine notification handler.
     * As with JRPCEngineV2, we don't use the engine to send notifications.
     */
    communicationEngineNotificationManager: SafeEventEmitter;
    /**
