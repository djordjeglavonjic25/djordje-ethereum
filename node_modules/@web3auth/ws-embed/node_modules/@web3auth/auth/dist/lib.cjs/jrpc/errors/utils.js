...
function getOriginalMessage(error) {
  if (utils.isObject(error) && utils.hasProperty(error, "message") && typeof error.message === "string" && error.message.length > 0) {
...
function dataHasCause(data) {
  return utils.isObject(data) && _objectHasOwn(data, "cause") && utils.isObject(data.cause);
}
