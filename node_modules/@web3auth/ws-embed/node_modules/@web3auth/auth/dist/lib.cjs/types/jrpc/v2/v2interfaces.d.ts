...
export type WithoutId<Request extends JsonRpcCall> = Request & {
    id?: never;
};
export type MixedParam<Request extends JsonRpcCall> = [Extract<Request, JRPCRequest>] extends [never] ? never : [Extract<Request, JRPCNotification>] extends [never] ? never : Extract<Request, JRPCRequest> | WithoutId<Extract<Request, JRPCNotification>>;
...
export type JRPCMiddlewareV2<Request extends JsonRpcCall = JsonRpcCall, Result extends ResultConstraint<Request> = ResultConstraint<Request>, Context extends ContextConstraint = MiddlewareContext> = (params: MiddlewareParams<Request, Context>) => Readonly<Result> | undefined | Promise<Readonly<Result> | undefined>;
 ...
 */
export type InvalidEngine<Message extends string> = {
 ...
 */
export type MiddlewareScaffold = Record<string, ((params: never) => Readonly<Json> | undefined | Promise<Readonly<Json> | undefined>) | JsonPrimitive>;
export type DeepCloned<Type> = Type extends readonly (infer ArrayType)[] ? DeepCloned<ArrayType>[] : Type extends object ? {
