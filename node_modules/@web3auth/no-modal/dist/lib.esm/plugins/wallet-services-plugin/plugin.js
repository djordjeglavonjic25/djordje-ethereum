...
class WalletServicesPlugin extends SafeEventEmitter {
  ...
  async showWalletConnectScanner(showWalletConnectParams) {
    ...
    if (!((_this$wsEmbedInstance = this.wsEmbedInstance) !== null && _this$wsEmbedInstance !== void 0 && _this$wsEmbedInstance.isLoggedIn)) throw WalletServicesPluginError.walletPluginNotConnected();
