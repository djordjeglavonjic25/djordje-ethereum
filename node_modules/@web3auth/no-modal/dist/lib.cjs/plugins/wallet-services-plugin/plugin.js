...
class WalletServicesPlugin extends auth.SafeEventEmitter {
  ...
  async showWalletConnectScanner(showWalletConnectParams) {
    var _this$wsEmbedInstance, _this$analytics;
    if (!((_this$wsEmbedInstance = this.wsEmbedInstance) !== null && _this$wsEmbedInstance !== void 0 && _this$wsEmbedInstance.isLoggedIn)) throw errors.WalletServicesPluginError.walletPluginNotConnected();
    // analytics
  ...
  async showFunding(showFundingParams) {
    var _this$wsEmbedInstance2, _this$analytics2;
  ...
  async showCheckout(showCheckoutParams) {
    var _this$wsEmbedInstance3, _this$analytics3;
  ...
  async showReceive(showReceiveParams) {
    var _this$wsEmbedInstance4, _this$analytics4;
  ...
  async showWalletUi(showWalletUiParams) {
    var _this$wsEmbedInstance5, _this$analytics5;
  ...
  async showSwap(showSwapParams) {
    var _this$wsEmbedInstance6, _this$analytics6;
  ...
  async cleanup() {
    ...
    return (_this$wsEmbedInstance7 = this.wsEmbedInstance) === null || _this$wsEmbedInstance7 === void 0 ? void 0 : _this$wsEmbedInstance7.cleanUp();
  }
  async disconnect() {
    ...
    if ((_this$wsEmbedInstance8 = this.wsEmbedInstance) !== null && _this$wsEmbedInstance8 !== void 0 && _this$wsEmbedInstance8.isLoggedIn) {
