...
const dashboardPublicApiUrl = buildEnv => {
  return constants$1.DASHBOARD_PUBLIC_API_MAP[buildEnv];
};
const citadelServerUrl = (buildEnv = auth.BUILD_ENV.PRODUCTION) => {
  return constants$1.CITADEL_SERVER_MAP[buildEnv];
};
...
const parseChainNamespaceFromCitadelResponse = chainNamespace => {
  if (chainNamespace === "evm") {
    return baseControllers.CHAIN_NAMESPACES.EIP155;
  }
...
exports.citadelServerUrl = citadelServerUrl;
exports.dashboardPublicApiUrl = dashboardPublicApiUrl;
...
exports.parseChainNamespaceFromCitadelResponse = parseChainNamespaceFromCitadelResponse;
