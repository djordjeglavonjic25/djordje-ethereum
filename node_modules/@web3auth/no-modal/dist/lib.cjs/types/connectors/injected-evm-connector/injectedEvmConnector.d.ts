...
import { BaseConnectorLoginParams, BaseConnectorSettings, ChainNamespaceType, Connection, CONNECTOR_CATEGORY_TYPE, CONNECTOR_STATUS_TYPE, ConnectorFn, ConnectorInitOptions, ConnectorNamespaceType, CustomChainConfig, IProvider, UserInfo } from "../../base";
...
declare class InjectedEvmConnector extends BaseEvmConnector<void> {
    ...
    connect({ chainId, getAuthTokenInfo }: BaseConnectorLoginParams): Promise<Connection | null>;
    disconnect(options?: {
        cleanup: boolean;
    }): Promise<void>;
