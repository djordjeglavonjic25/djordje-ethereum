...
const useSignMessage = () => {
  ...
  const signMessage = async (message, from) => {
    ...
    try {
      ...
      const signature = await solana.walletSignMessage(solanaWallet.value, message, from !== null && from !== void 0 ? from : (_accounts$value = accounts.value) === null || _accounts$value === void 0 ? void 0 : _accounts$value[0]);
