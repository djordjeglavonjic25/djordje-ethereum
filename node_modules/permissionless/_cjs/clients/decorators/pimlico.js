...
const pimlicoActions = ({ entryPoint }) => (client) => ({
    ...
    sendCompressedUserOperation: async (args) => (0, index_js_1.sendCompressedUserOperation)(client, {
        ...args,
    ...
    validateSponsorshipPolicies: async (args) => (0, index_js_1.validateSponsorshipPolicies)(client, {
        ...args,
        entryPointAddress: entryPoint.address
    }),
    getTokenQuotes: async (args) => (0, index_js_1.getTokenQuotes)(client, {
        ...args,
        chain: args.chain,
        entryPointAddress: entryPoint.address
    }),
