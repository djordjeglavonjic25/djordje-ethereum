...
const index_js_1 = require("../../../actions/pimlico/index.js");
...
const prepareUserOperationForErc20Paymaster = (pimlicoClient, { balanceOverride = false, balanceSlot: _balanceSlot } = {}) => async (client, parameters_) => {
    ...
    if (typeof paymasterContext === "object" &&
        ...
        const quotes = await (0, utils_1.getAction)(pimlicoClient, index_js_1.getTokenQuotes, "getTokenQuotes")({
            tokens: [token],
        ...
        const { postOpGas, exchangeRate, paymaster: paymasterERC20Address } = quote;
        ...
        const callsWithDummyApproval = [
            {
                ...
                args: [paymasterERC20Address, viem_1.maxUint256], // dummy approval to ensure simulation passes
        ...
        const allowance = await (0, utils_1.getAction)(publicClient, actions_1.readContract, "readContract")({
            abi: viem_1.erc20Abi,
