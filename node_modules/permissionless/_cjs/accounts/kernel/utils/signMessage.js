...
async function signMessage({ message, owner, address: accountAddress, version: accountVersion, chainId, eip7702 = false }) {
    if ((0, isWebAuthnAccount_js_1.isWebAuthnAccount)(owner)) {
        let messageContent;
        if (typeof message === "string") {
            messageContent = (0, wrapMessageHash_js_1.wrapMessageHash)({
        ...
        const { Signature } = await (0, ox_js_1.getOxExports)();
    ...
    const wrappedMessageHash = (0, wrapMessageHash_js_1.wrapMessageHash)({
        hash: (0, viem_1.hashMessage)(message),
        version: accountVersion,
        address: accountAddress,
        chainId
