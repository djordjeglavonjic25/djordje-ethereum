...
import { type BundlerActions, type BundlerClientConfig, type PaymasterActions, type PrepareUserOperationParameters, type PrepareUserOperationReturnType, type SmartAccount, type UserOperationRequest } from "viem/account-abstraction";
 ...
 */
type SmartAccountClientInner<transport extends Transport, chain extends Chain | undefined, account extends SmartAccount | undefined, client extends Client | undefined, rpcSchema extends RpcSchema | undefined> = Client<transport, chain extends Chain ? chain : client extends Client<any, infer chain> ? chain : undefined, account, rpcSchema extends RpcSchema ? [...BundlerRpcSchema, ...rpcSchema] : BundlerRpcSchema, BundlerActions<account> & SmartAccountActions<chain, account>> & {
    client: client;
    paymaster: BundlerClientConfig["paymaster"] | undefined;
    paymasterContext: BundlerClientConfig["paymasterContext"] | undefined;
    userOperation: BundlerClientConfig["userOperation"] | undefined;
};
export type SmartAccountClient<out transport extends Transport = Transport, 
/** @ts-expect-error cast variance */
out chain extends Chain | undefined = Chain | undefined, 
/** @ts-expect-error cast variance */
out account extends SmartAccount | undefined = SmartAccount | undefined, out client extends Client | undefined = Client | undefined, rpcSchema extends RpcSchema | undefined = undefined> = {
    [key in keyof SmartAccountClientInner<transport, chain, account, client, rpcSchema>]: SmartAccountClientInner<transport, chain, account, client, rpcSchema>[key];
};
export type SmartAccountClientConfig<transport extends Transport = Transport, chain extends Chain | undefined = Chain | undefined, account extends SmartAccount | undefined = SmartAccount | undefined, client extends Client | undefined = Client | undefined, rpcSchema extends RpcSchema | undefined = undefined> = Prettify<Pick<ClientConfig<transport, chain, account, rpcSchema>, "account" | "cacheTime" | "chain" | "key" | "name" | "pollingInterval" | "rpcSchema">> & {
    ...
    userOperation?: {
        ...
        prepareUserOperation?: ((client: Client<Transport, Chain | undefined, SmartAccount | undefined>, parameters: PrepareUserOperationParameters) => Promise<PrepareUserOperationReturnType>) | undefined;
    } | undefined;
};
